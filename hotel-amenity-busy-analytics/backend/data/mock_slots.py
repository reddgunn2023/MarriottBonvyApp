...
_PEAK_PATTERNS = {
    ...
    "Spa": [0.3, 0.5, 0.9, 1.0, 0.85, 0.7, 0.6, 0.2],
    "Fitness Center": [0.8, 0.6, 0.4, 0.3, 0.3, 0.5, 0.7, 0.4],
    "Pool": [0.1, 0.4, 0.8, 1.0, 0.9, 0.7, 0.3, 0.05],
    "Free Breakfast": [0.4, 0.95, 1.0, 0.2, 0.05, 0.0, 0.0, 0.0],
    "Whirlpool Onsite": [0.1, 0.2, 0.45, 0.65, 0.75, 0.8, 0.9, 0.6],
    "Restaurants": [0.05, 0.1, 0.35, 0.65, 0.55, 0.85, 1.0, 0.9],
    "Lounges": [0.0, 0.05, 0.1, 0.25, 0.4, 0.65, 0.95, 1.0],
    "EV Charging": [0.45, 0.65, 0.7, 0.55, 0.5, 0.75, 1.0, 0.7],
}
